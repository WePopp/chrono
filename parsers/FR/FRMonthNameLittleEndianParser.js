...
(function () {
  ...
  var regPattern  = /(\s+|^)((Dimanche|Lundi|Mardi|Mercredi|Jeudi|Vendredi|Samedi|Dim|Lun|Mar|Mer|Jeu|Ven|Sam)\s*,?\s*)?([0-2]?[0-9]|3[0-1])(\s*(Janvier|Jan|Février|Fevrier|Fev|Mars|Mar|Avril|Avr|Mai|Juin|Juillet|Juil|Aout|Août|Septembre|Sept|Octobre|Oct|Novembre|Nov|Decembre|Décembre|Dec))((\s*[0-9]{2,4})(\s*BE)?)?(\W|_|$)/i;
