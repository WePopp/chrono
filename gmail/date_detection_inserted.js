 ...
 // var bounds = getRealBodyBounds(text);
  ...
  for(var i=0; i<detectedDates.length; i++) {
    ...
    detectedDates[i].results.sort(function(detectedDateA, detectedDateB) {
        ...
        var span = "<span class='wetime-date-link' data-timezone-region='"+ detectedDate.start.timezoneRegion +"' data-value='" + dateString + "'>" + detectedText + "<div class='conflict-dot'></div></span>"
